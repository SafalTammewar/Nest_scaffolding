...
ErrorcodesModule = __decorate([
    common_1.Module({
        providers: [logger_service_1.LogService, errorcodes_service_1.ErrorcodesService, general_errocodes_config_1.GeneralCodes],
        controllers: [errorcodes_controller_1.ErrorcodesController],
        exports: [errorcodes_service_1.ErrorcodesService, general_errocodes_config_1.GeneralCodes]
    })
], ErrorcodesModule);
